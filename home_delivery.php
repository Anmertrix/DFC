...
<?php include_once('header.php') ?>
	...
	<section id="main_head" class="main_head" style="background-image:url(img/bg1.jpg)">
		<div class="container">
			<div class="main_head_content">
				...
				<div class="main_head_right">
					<form method="post">
						<div class="form_title">Заявка на доставку товара</div>
						<div class="form_wrap">
							<input type="text" name="Departures" placeholder="Пункт отправления *" required>
							<input type="text" name="Name" placeholder="Наименование груза">
							<input type="text" name="Weight" placeholder="ВЕС (кг)">
							<input type="text" name="Volume" placeholder="ОбЪЁм (м.куб)">
							<input type="text" name="Destination" placeholder="Пункт назначения *" required>
				...
				<div class="main_head_link_tabs">
					<a href="http://mydfc.ru/catalog" class="main_head_link_tab">
						<div class="title">Товары</div>
						<div class="text">Смотреть все товары</div>
						<div class="main_head_link_icon"><span class="lnr lnr-chevron-right"></span></div>
					</a>
					<a href="http://mydfc.ru/cargo" class="main_head_link_tab">
